...
const CONFIG = {
  ...
  6: {
    ...
    subjects: [
      ...
      { key: "s_science",        label: "S.Science (G+C+H)",     isAggregate: true,  components: ["geography", "civics", "history"], countInTotal: true,  singleTotal: false },
      ...
      { key: "english_i_ii",     label: "English (I+II)",        isAggregate: true,  components: ["english_i", "english_ii"],        countInTotal: true,  singleTotal: false },
  ...
  7: {
    ...
    subjects: [
      ...
      { key: "civics",           label: "Civics",                isAggregate: false, components: [],                                 countInTotal: false, singleTotal: false },
      { key: "history",          label: "History",               isAggregate: false, components: [],                                 countInTotal: false, singleTotal: false },
      { key: "s_science",        label: "S.Science (G+C+H+E)",   isAggregate: true,  components: ["geography", "civics", "history"], countInTotal: true,  singleTotal: false },
      { key: "english_i",        label: "English I",             isAggregate: false, components: [],                                 countInTotal: false, singleTotal: false },
      { key: "english_ii",       label: "English II",            isAggregate: false, components: [],                                 countInTotal: false, singleTotal: false },
      { key: "english_i_ii",     label: "English (I+II)",        isAggregate: true,  components: ["english_i", "english_ii"],        countInTotal: true,  singleTotal: false },
  ...
  9: {
    ...
    subjects: [
      ...
      { key: "science_pcb",      label: "Science (P+C+B)",       isAggregate: true,  components: ["physics", "chemistry", "biology"],                  countInTotal: true,  singleTotal: false },
      { key: "geography",        label: "Geography",             isAggregate: false, components: [],                                                   countInTotal: false, singleTotal: false },
      { key: "civics",           label: "Civics",                isAggregate: false, components: [],                                                   countInTotal: false, singleTotal: false },
      { key: "history",          label: "History",               isAggregate: false, components: [],                                                   countInTotal: false, singleTotal: false },
      { key: "economics",        label: "Economics",             isAggregate: false, components: [],                                                   countInTotal: false, singleTotal: false },
      { key: "s_science",        label: "S.Science (G+C+H+E)",   isAggregate: true,  components: ["geography", "civics", "history", "economics"],      countInTotal: true,  singleTotal: false },
      { key: "english_i",        label: "English I",             isAggregate: false, components: [],                                                   countInTotal: false, singleTotal: false },
      { key: "english_ii",       label: "English II",            isAggregate: false, components: [],                                                   countInTotal: false, singleTotal: false },
      { key: "english_i_ii",     label: "English (I+II)",        isAggregate: true,  components: ["english_i", "english_ii"],                          countInTotal: true,  singleTotal: false },
      { key: "h_education",      label: "H.Education",           isAggregate: false, components: [],                                                   countInTotal: true,  singleTotal: false },
